...
function AuthGuard({ children }) {
    ...
    const { isAuthenticated, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSelector"])((state)=>state.auth);
...
"[project]/src/services/mockData.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MockService = {
    ...
    updateListingStatus: async (id, status)=>{
        await new Promise((resolve)=>setTimeout(resolve, 500));
        const allCrops = getStorageData(STORAGE_KEYS.CROPS, INITIAL_CROPS);
        const updatedCrops = allCrops.map((crop)=>crop.id === id ? {
                ...crop,
                status
            } : crop);
        setStorageData(STORAGE_KEYS.CROPS, updatedCrops);
    ...
    updateListing: async (id, updates)=>{
        await new Promise((resolve)=>setTimeout(resolve, 800));
        const allCrops = getStorageData(STORAGE_KEYS.CROPS, INITIAL_CROPS);
        const updatedCrops = allCrops.map((crop)=>crop.id.toString() === id.toString() ? {
                ...crop,
                ...updates
            } : crop);
        setStorageData(STORAGE_KEYS.CROPS, updatedCrops);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$mockData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/mockData.js [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function MarketPage() {
    ...
    const [showFilters, setShowFilters] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // Mobile filter toggle
    ...
    const [filteredCrops, setFilteredCrops] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadCrops = async ()=>{
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$mockData$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MockService"].getMarketCrops();
            ...
            console.error(error);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2f$Toast$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(t('common.error') || "Failed to load market data");
        } finally{
            setIsLoading(false);
        }
    };
    ...
    const handleAddToCart = (item)=>{
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$cartSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addToCart"])({
            id: item.id,
            name: item.name,
            price: item.price,
            image: item.image,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2f$Toast$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(t('cart.added') || `${item.name} added to cart!`);
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$slices$2f$cartSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["openCart"])());
    };
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    lineNumber: 203,
                                    columnNumber: 33
                                }, this) : filteredCrops.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6",
                                    children: filteredCrops.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_c23de237._.js.map